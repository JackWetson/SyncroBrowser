...
ActiveRecord::Schema[7.0].define(version: 20_220_420_131_305) do
  ...
  create_table 'memberships_reassignments_assignments', force: :cascade do |t|
    ...
    t.index ['scaffolding_completely_concrete_tangible_things_reassignments_i'],
            name: 'index_assignments_on_tangible_things_reassignment_id'
  end
  ...
  add_foreign_key 'memberships_reassignments_assignments',
                  'memberships_reassignments_scaffolding_completely_concrete_tangi', column: 'scaffolding_completely_concrete_tangible_things_reassignments_i'
  ...
  add_foreign_key 'scaffolding_absolutely_abstract_creative_concepts_collaborators',
                  'scaffolding_absolutely_abstract_creative_concepts', column: 'creative_concept_id'
  add_foreign_key 'scaffolding_completely_concrete_tangible_things',
                  'scaffolding_absolutely_abstract_creative_concepts', column: 'absolutely_abstract_creative_concept_id'
  add_foreign_key 'scaffolding_completely_concrete_tangible_things_assignments', 'memberships'
  add_foreign_key 'scaffolding_completely_concrete_tangible_things_assignments',
                  'scaffolding_completely_concrete_tangible_things', column: 'tangible_thing_id'
