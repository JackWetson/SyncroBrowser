...
module Account
  module Scaffolding
    module AbsolutelyAbstract
      class CreativeConceptsControllerTest < ActionDispatch::IntegrationTest
        ...
        unless scaffolding_things_disabled? # 🚅 skip when scaffolding.
          ...
          test 'should create creative_concept' do
            assert_difference('Scaffolding::AbsolutelyAbstract::CreativeConcept.count') do
              post account_team_scaffolding_absolutely_abstract_creative_concepts_url(@team),
                   params: { scaffolding_absolutely_abstract_creative_concept: { name: @creative_concept.name } }
            end
          ...
          test 'should update creative_concept' do
            patch account_scaffolding_absolutely_abstract_creative_concept_url(@creative_concept),
                  params: { scaffolding_absolutely_abstract_creative_concept: { name: @creative_concept.name } }
