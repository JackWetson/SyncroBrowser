...
module Api
  module V1
    class TeamsEndpointTest < Api::Test
      ...
      test 'index' do
        ...
        get '/api/v1/teams', params: { access_token: }
        assert_response :success

        # Make sure it's returning our resources.
        team_ids_returned = response.parsed_body['data'].map { |team| team.dig('attributes', 'id') }
      ...
      test 'show' do
        # Fetch and ensure nothing is seriously broken.
        get "/api/v1/teams/#{@team.id}", params: { access_token: }
        assert_response :success
      ...
      test 'create' do
        ...
        post '/api/v1/teams',
             params: team_data.merge({ access_token: })
      ...
      test 'destroy' do
        ...
        delete "/api/v1/teams/#{@team.id}", params: { access_token: }
