  ...
  module V1
    module Scaffolding
      module CompletelyConcrete
        class TangibleThingsEndpointTest < Api::Test
          ...
          unless scaffolding_things_disabled? # 🚅 skip when scaffolding.
            def setup
              ...
              @absolutely_abstract_creative_concept = create(:scaffolding_absolutely_abstract_creative_concept,
                                                             team: @team)
              @tangible_thing = create(:scaffolding_completely_concrete_tangible_thing,
            ...
            def assert_proper_object_serialization(tangible_thing_data)
              ...
              assert_equal DateTime.parse(tangible_thing_data['date_and_time_field_value']),
                           tangible_thing.date_and_time_field_value
              ...
              assert_equal tangible_thing_data['absolutely_abstract_creative_concept_id'],
                           tangible_thing.absolutely_abstract_creative_concept_id
            end

            test 'index' do
              # Fetch and ensure nothing is seriously broken.
              get "/api/v1/scaffolding/absolutely_abstract/creative_concepts/#{@absolutely_abstract_creative_concept.id}/completely_concrete/tangible_things",
                  params: { access_token: }
              assert_response :success

              # Make sure it's returning our resources.
              tangible_thing_ids_returned = response.parsed_body['data'].map do |tangible_thing|
                tangible_thing.dig('attributes', 'id')
              end
            ...
            test 'show' do
              # Fetch and ensure nothing is seriously broken.
              get "/api/v1/scaffolding/completely_concrete/tangible_things/#{@tangible_thing.id}",
                  params: { access_token: }
              assert_response :success
              ...
              get "/api/v1/scaffolding/completely_concrete/tangible_things/#{@tangible_thing.id}",
                  params: { access_token: another_access_token }
              assert_response_specific_not_found
            end

            test 'create' do
              # Use the serializer to generate a payload, but strip some attributes out.
              tangible_thing_data = Api::V1::Scaffolding::CompletelyConcrete::TangibleThingSerializer.new(build(:scaffolding_completely_concrete_tangible_thing, absolutely_abstract_creative_concept: nil)).serializable_hash.dig(
                :data, :attributes
              )
              ...
              post "/api/v1/scaffolding/absolutely_abstract/creative_concepts/#{@absolutely_abstract_creative_concept.id}/completely_concrete/tangible_things",
                   params: tangible_thing_data.merge({ access_token: })
            ...
            test 'update' do
              ...
              # Also ensure we can't do that same action as another user.
              put "/api/v1/scaffolding/completely_concrete/tangible_things/#{@tangible_thing.id}",
                  params: { access_token: another_access_token }
              assert_response_specific_not_found
            end
            ...
            test 'destroy' do
              ...
              assert_difference('Scaffolding::CompletelyConcrete::TangibleThing.count', -1) do
                delete "/api/v1/scaffolding/completely_concrete/tangible_things/#{@tangible_thing.id}",
                       params: { access_token: }
                assert_response :success
              end
